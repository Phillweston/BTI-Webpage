const CONFIG = {
  ...
  HEXO_HOME_BANNER_GREETINGS: ['Discover the Technology Behind BTI-Coin 🌐', 'Unveiling the Future of Cryptocurrency 💡', 'Join Our Journey into the Digital Frontier 🚀'], // 首页大图标语文字
