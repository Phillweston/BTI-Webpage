const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>Bitcoin Enthusiast<br/>/Cryptocurrency Investor<br/>/Knowledge Sharing Blogger</div>',
