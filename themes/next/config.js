const CONFIG = {
  ...
  NEXT_HOME_BANNER_STRINGS: ['Discover the Technology Behind BTI-Platform 🌐', 'Unveiling the Future of Cryptocurrency 💡', 'Join Our Journey into the Digital Frontier 🚀'], // 首页大图标语文字
