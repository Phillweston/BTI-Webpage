...
const Footer = ({ siteInfo }) => {
  ...
  return (
        ...
        >
            ...
            <div className='text-xs font-serif py-1'>Powered By <a href='https://github.com/BTI-US/BTI-Webpage' className='underline text-gray-500 dark:text-gray-300'>NotionNext</a></div>
